...
todo_list = ['Go shopping ','Clean Room','Recore video']
    ...
    while not done:
        try:
            with speech_recognition.Microphone() as mic:
                ...
                speaker.say(f"I added {item} into your to do list!")
                speaker.runAndWait()
...
def hello():
    speaker.say("Hello Aakanksha What can I do for you!")
    speaker.runAndWait()

def exit():
    speaker.say("Bye Aakanksha")
    speaker.runAndWait()
    sys.exit(0)
